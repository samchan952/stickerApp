<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
    <div class="grid gap-4">
        <div class="relative">
            ...
            <div class="absolute bottom-0 left-0 w-full flex justify-center">
                <a target="_blank" href="https://tailwindcomponents.com" class="group font-medium tracking-wide select-none text-base relative inline-flex items-center justify-center cursor-pointer h-12 border-2 border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-blue-500 text-white border-blue-500 hover:text-blue-500 focus:text-blue-500">
                    ...
                    <span class="absolute bg-white bottom-0 w-0 left-1/2 h-full -translate-x-1/2 transition-all ease-in-out duration-700 group-hover:w-[105%] -z-[1] group-focus:w-[105%]"></span>
                </a>
            </div>
        </div>
        
        <div class="relative">
            <img class="h-auto max-w-full rounded-lg duration-300" src="{{asset('assets/images/img1.jpg')}}" alt="">
            <div class="absolute bottom-0 left-0 w-full flex justify-center">
                <a target="_blank" href="https://tailwindcomponents.com" class="group font-medium tracking-wide select-none text-base relative inline-flex items-center justify-center cursor-pointer h-12 border-2 border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-blue-500 text-white border-blue-500 hover:text-blue-500 focus:text-blue-500">
                    <strong class="font-medium">Buy Me</strong>
                    <svg class="ml-1 rotate-180 fill-white group-hover:fill-blue-500" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="relative">
            <img class="h-auto max-w-full rounded-lg duration-300" src="{{asset('assets/images/img2.jpg')}}" alt="">
            <div class="absolute bottom-0 left-0 w-full flex justify-center">
                <a target="_blank" href="https://tailwindcomponents.com" class="group font-medium tracking-wide select-none text-base relative inline-flex items-center justify-center cursor-pointer h-12 border-2 border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-blue-500 text-white border-blue-500 hover:text-blue-500 focus:text-blue-500">
                    <strong class="font-medium">Buy Me</strong>
                    <svg class="ml-1 rotate-180 fill-white group-hover:fill-blue-500" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="grid gap-4">
        ...
        <div class="relative">
            <img class="h-auto max-w-full rounded-lg duration-300" src="{{asset('assets/images/img3.jpg')}}" alt="">
            <div class="absolute bottom-0 left-0 w-full flex justify-center">
                <a target="_blank" href="https://tailwindcomponents.com" class="group font-medium tracking-wide select-none text-base relative inline-flex items-center justify-center cursor-pointer h-12 border-2 border-solid py-0 px-6 rounded-md overflow-hidden z-10 transition-all duration-300 ease-in-out outline-0 bg-blue-500 text-white border-blue-500 hover:text-blue-500 focus:text-blue-500">
                    <strong class="font-medium">Buy Me</strong>
                    <svg class="ml-1 rotate-180 fill-white group-hover:fill-blue-500" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
